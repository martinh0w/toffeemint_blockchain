// UpdateLetterOfCreditStatus.java
...
public class UpdateLetterOfCreditStatus {
...
//		String apiServiceUrl = "http://localhost:8080/SMUtBank_API/Gateway";
		...
		try {		
			...
			jo.put("serviceName", "updateLetterOfCreditStatus");
			...
			jo.put("status", "ISSUED");
			jo.put("statusDetails", "anything");
